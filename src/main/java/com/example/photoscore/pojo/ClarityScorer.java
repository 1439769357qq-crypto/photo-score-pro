...
public class ClarityScorer extends BaseScorer {
    ...
    protected double calculateRawScore(ScoringImageContext context) {
        try (AutoMat laplacian = AutoMat.empty();
            ...
            Imgproc.Sobel(gray, sobelX.get(), CvType.CV_64F, 1, 0);
            Imgproc.Sobel(gray, sobelY.get(), CvType.CV_64F, 0, 1);
