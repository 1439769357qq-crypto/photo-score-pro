...
public class BatchScoreResponse {
    ...
    private String deepSeekSelectionSummary;
    private String deepSeekSelectionStrategy;
    private String deepSeekKeepAdvice;
    private String deepSeekEliminateAdvice;
